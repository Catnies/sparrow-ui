...
@ReflectionProxy(name = "net.minecraft.network.ProtocolInfo$DetailsProvider", activeIf = "min_version=1.21.8")
public interface ProtocolInfoDetailsProviderProxy {
    ...
    @MethodInvoker(name = "details", activeIf = "min_version=1.21.8")
