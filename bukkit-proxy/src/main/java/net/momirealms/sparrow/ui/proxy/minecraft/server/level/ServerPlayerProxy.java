...
public interface ServerPlayerProxy extends PlayerProxy {
    ...
    @MethodInvoker(name = "drop", activeIf = "min_version=26.2 && max_version=26.2 && !has_patch=paper")
    ...
    @MethodInvoker(name = "drop", activeIf = "min_version=26.3 && !has_patch=paper")
    Object drop$2(Object target, @Type(clazz = ItemStackProxy.class) Object item, boolean thrownFromHand, @Type(name = "net.minecraft.util.Prediction") Object prediction, boolean callEvent);
