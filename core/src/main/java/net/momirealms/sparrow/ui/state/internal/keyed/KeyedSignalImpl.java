...
public sealed class KeyedSignalImpl<K, T> extends AbstractKeyedSignal<K, T, KeyedSignalImpl.SyncPartition<K, T>> implements MutableKeyedSignal<K, T> permits MutablePlayerKeyedSignalImpl {
    ...
    public KeyedSignalImpl(Function<? super K, ? extends T> initial) {
        this(initial, AbstractSignal.defaultSameValue());
    }

    public KeyedSignalImpl(Function<? super K, ? extends T> initial, BiPredicate<? super T, ? super T> sameValue) {
