...
@ApiStatus.Internal
public final class ConfigurationAcknowledgedListener implements ByteBufPacketListener {
    public static final ByteBufPacketListener INSTANCE = new ConfigurationAcknowledgedListener();
