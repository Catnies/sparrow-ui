...
@ApiStatus.Internal
public sealed class MapDistinctSignal<S, T> extends AbstractSignal<T> permits LensSignal {
    ...
    public MapDistinctSignal(AbstractSignal<S> source, Function<? super S, ? extends T> mapper, BiPredicate<? super T, ? super T> sameValue) {
        this.source = source;
        this.mapper = mapper;
