...
@ApiStatus.Internal
public final class TickingSignal extends AbstractSignal<Long> {
    ...
    public TickingSignal(Ticker ticker) {
        this.ticker = ticker;
    }
    ...
    @NotNull
    public Signal<Long> every(long periodTicks) {
    ...
    @NotNull
    public static TickingSignal.Ticker platformTicker() {
        return onTick -> {
            // 单个调度任务内只有一个写者
    ...
    @NotNull
    public static TickingSignal.Ticker millisTicker(long periodMillis) {
        return onTick -> {
