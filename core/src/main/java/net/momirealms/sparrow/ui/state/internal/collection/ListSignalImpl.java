...
@ApiStatus.Internal
public final class ListSignalImpl<E> extends CollectionSignal<List<E>> implements MutableListSignal<E> {
    private final List<E> delegate;
    private final Facade root;
    @Nullable private ListSignal<E> readOnly;
    ...
    public ListSignalImpl(List<E> delegate) {
    ...
    @Override
    @NotNull
    public synchronized ListSignal<E> asReadOnly() {
        if (this.readOnly == null) {
            this.readOnly = new ReadOnlyListSignal<>(this);
        }
