...
@ApiStatus.Internal
public final class StartConfigurationListener implements ByteBufPacketHandler {
    public static final ByteBufPacketHandler INSTANCE = new StartConfigurationListener();
