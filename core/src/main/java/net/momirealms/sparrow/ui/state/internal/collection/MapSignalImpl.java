...
@ApiStatus.Internal
public final class MapSignalImpl<K, V> extends CollectionSignal<Map<K, V>> implements MutableMapSignal<K, V> {
    private final Map<K, V> delegate;
    @Nullable private MapSignal<K, V> readOnly;
    ...
    public MapSignalImpl(Map<K, V> delegate) {
    ...
    @Override
    @NotNull
    public synchronized MapSignal<K, V> asReadOnly() {
        if (this.readOnly == null) {
            this.readOnly = new ReadOnlyMapSignal<>(this);
        }
